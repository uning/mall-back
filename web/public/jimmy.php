...
*/
//dotest( 'UserController.get_items',$p = array('u'=>25));
...
dotest('UserController.cheat',$p=array('u'=>23,'money'=>1000000));
//dotest('UserController.cheat',$p=array('u'=>23,'gem'=>1000));
//dotest('UserController.cheat',$p=array('u'=>23,'exp'=>-100000));
