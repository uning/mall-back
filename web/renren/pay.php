			...
			<div id="header">
			   ...
			   <div id="tabs">
				<ul class="clearfix tcenter">       
					...
					<li class="freegift"><a href="http://apps.renren.com/livemall#switchToGift" id="freeGift" >免费礼物</a></li>
					<li class="invite" ><a href="http://apps.renren.com/livemall#switchToInvite" >邀请好友</a></li>
