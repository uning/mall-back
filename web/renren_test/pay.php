...
?>
	...
	function buyPoints()
	{
		...
		ajax.ondone = function(data) {
			...
			if(data.token){
				new Dialog(Dialog.DIALOG_ALERT, {message: '验证成功，点确定进入支付页面。', title: '提交订单', callBack:function(){
					...
					redirect_url.setValue('<?php echo RenrenConfig::$canvas_url."/pay_history.php"; ?>'+'?order_id='+ data.order_number);
					console.log(form);
					form.submit();
				}
				}
		...
		ajax.post('<?php echo RenrenConfig::$canvas_url."/pay_new_order.php";?>',params, true);
	}
  </script>
...
<div class="poker_main">
	 ...
	 <img src="<?php echo RenrenConfig::$resource_urlp; ?>images/poker_jinbicz.jpg" width="134" height="32" />
     <div class="back_game"><a href="<?php echo RenrenConfig::$canvas_url;?>/index.php"><img src="<?php echo RenrenConfig::$resource_urlp; ?>images/poker_backgame.jpg" width="109" height="28" /></a></div>
     </div>
	<div class="poker_pay"> 
      	<div class="poker_pay_top"><a <?php if($myself=='pay.php') echo "class='select'";?> href="<?php echo RenrenConfig::$canvas_url;?>/pay.php">游戏充值</a> <a <?php if($myself=='pay_history.php') echo "class='select'";?> href="<?php echo RenrenConfig::$canvas_url;?>/pay_history.php">充值记录</a></div>
        <div class="poker_pay_type">
       	  <h1>选择您要充值的类型：</h1>
          <div class="poker_pay_yxb">
          	<img src="<?php echo RenrenConfig::$resource_urlp; ?>images/poker_yxb_cz.jpg" width="160" height="43" />
  <ul>
          ...
          <img src="<?php echo RenrenConfig::$resource_urlp; ?>images/poker_jb_cz.jpg" width="160" height="43" />
<ul>
        ...
        <button onclick="buyPoints()" type="submit"><img src="<?php echo RenrenConfig::$resource_urlp; ?>images/poker_pay_ok.jpg" width="108" height="45" border="0" /></button>
        </div>  
	</div>
